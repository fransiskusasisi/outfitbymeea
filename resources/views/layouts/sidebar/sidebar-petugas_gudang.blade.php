<aside class="fixed top-0 left-0 h-full w-64 bg-gradient-to-b from-purple-700 to-indigo-800 text-white p-4 space-y-2 shadow-lg">

    <!-- Header Sidebar -->
    <div class="flex flex-col items-center justify-center mb-6">
        <div class="w-20 h-20 rounded-full overflow-hidden border-4 border-white shadow-lg">
            <img src="{{ asset('images/logo.png') }}" 
                 alt="Logo Outfitbymee" 
    ...
    <nav class="space-y-1">
        ...
        <button onclick="toggleDropdown('data-master')" 
            ...
            <svg id="data-master-arrow" class="dropdown-arrow w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div id="data-master" class="submenu pl-6">
            ...
            <a href="{{ route('kategori.index') }}" class="block px-2 py-2 text-sm hover:bg-purple-600 rounded">Kategori</a>
        ...
        <button onclick="toggleDropdown('stok-barang')" 
            ...
            <svg id="stok-barang-arrow" class="dropdown-arrow w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
            </svg>
        </button>
        <div id="stok-barang" class="submenu pl-6">
            <a href="{{ route('barangmasuk.index') }}" class="block px-2 py-2 text-sm hover:bg-purple-600 rounded">Barang Masuk</a>
            <a href="{{ route('barangkeluar.index') }}" class="block px-2 py-2 text-sm hover:bg-purple-600 rounded">Barang Keluar</a>
        </div>
